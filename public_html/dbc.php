...
define ("DB_HOST", "mysql14.000webhost.com"); // set database host
define ("DB_USER", "a8947044_1"); // set database user
define ("DB_PASS","d0n0tsk1p"); // set database password
define ("DB_NAME","a8947044_1"); // set database name

$publickey = "6LcWyu0SAAAAAMrZTwBxhSu1VGikvKBtSQetzL31";
$privatekey = "6LcWyu0SAAAAAM5QxIk-1_M7D2p8-kW6Hxqss_FF";
