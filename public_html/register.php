...
****************************************************************/
 require_once('recaptchalib.php');
      $privatekey = "6Lddf-8SAAAAADhCVlOb2hLVixYo632_9OfgFa5l";
...
$sql_insert = "INSERT into `users` (`user_email`,`pwd`,`date`,`users_ip`,`activation_code`,`user_name`)
        ...
        <table width="95%" border="0" cellpadding="3" cellspacing="3" class="forms">
          ...
          <tr> 
            ...
            <td width="78%"> 
              <?php 
        			   require_once('recaptchalib.php');
        			   $publickey = "6Lddf-8SAAAAAE_y-STLdAQ1HHlR8ajmCNlVynI0";
